...
A modern, browser-based **Image Encryption & Decryption Web Application** built entirely using  
**HTML5, CSS3, JavaScript, and Canvas API**.
...
➡️ The project runs instantly in any modern browser.
